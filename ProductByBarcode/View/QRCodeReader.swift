//  Project name: ProductByBarcode
//  File name   : QRCodeReader.swift
//
//  Author      : Dung Vu
//  Created date: 12/20/16
//  Version     : 1.00
//  --------------------------------------------------------------
...
public final class QRCodeReader: NSObject, AVCaptureMetadataOutputObjectsDelegate {
    ...
    public convenience override init() {
        self.init(metadataObjectTypes: [AVMetadataObjectTypeQRCode, AVMetadataObjectTypeEAN13Code, AVMetadataObjectTypeEAN8Code], captureDevicePosition: .back)
    }
    ...
    public func captureOutput(_ captureOutput: AVCaptureOutput!, didOutputMetadataObjects metadataObjects: [Any]!, from connection: AVCaptureConnection!) {
        for current in metadataObjects {
            if let _readableCodeObject = current as? AVMetadataMachineReadableCodeObject {
                print(_readableCodeObject.type)
